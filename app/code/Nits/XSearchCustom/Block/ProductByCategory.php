...
namespace Nits\XSearchCustom\Block;
...
class ProductByCategory extends ListProduct
{
    ...
    private function initializeProductCollection()
    {
        ...
        $layer = $this->getLayer();
        $this->setCategoryId($this->getRequest()->getParam('cat') ? $this->getRequest()->getParam('cat') : $this->_storeManager->getStore()->getRootCategoryId());
        $origCategory = null;
     ...
     * @return string
     */
    private function addFormKey(string $html): string
    {
