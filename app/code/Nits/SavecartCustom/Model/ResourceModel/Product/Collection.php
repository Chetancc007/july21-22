...
namespace Nits\SavecartCustom\Model\ResourceModel\Product;
...
class Collection extends AbstractCollection
{
    ...
    public function filterCollection($customerId)
    {
        ...
        $select->joinRight(
            ...
            "main_table.product_id = cpev.{$idField} AND cpev.attribute_id = {$attrId} AND cpev.store_id = {$this->getStoreId()}",
            'value'
        );
        return $this;
    }
