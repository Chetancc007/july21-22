Current version of tests is for Magento CE 2.3.3 with Amasty Improved Sorting 2.8.2 only.
Release version consists of 12 smoke tests (by one smoke test for each Soting Option).  
