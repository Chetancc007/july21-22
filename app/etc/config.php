...
return [
    'modules' => [
        ...
        'Mirasvit_Feed' => 1,
        'Mirasvit_Report' => 1,
        'Nits_AddPrePurchaseFlagToCart' => 1,
        'Nits_GetFrontendCartData' => 1,
        'Nits_OdooconnectorCustomization' => 1,
        'Nits_Porto' => 1,
        'Nits_ProductAutoSyncWithOdoo' => 1,
        'Nits_RestrictProduct' => 0,
        'Nits_SavecartCustom' => 1,
        'Nits_TableAttributeApi' => 1,
        'Nits_TextDbschema' => 1,
        'Nits_XSearchCustom' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_RMA' => 1,
        'Smartwave_Core' => 1,
        ...
        'Webkul_ProductTableAttribute' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
